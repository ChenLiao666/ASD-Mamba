...
{"id_train": r'/home/jxnu/LC/train240/train/trainASD.csv',
     "stimuli_dir": r'/home/jxnu/LC/train240/train/Images/',
     "saliency_dir": r'/home/jxnu/LC/train240/train/ASDgt/', "fixation_dir": r'/home/jxnu/LC/train240/train/ASDfix/',
     "label": 1}
...
{"id_val": r'/home/jxnu/LC/train240/test/testASD.csv', "stimuli_dir": r'/home/jxnu/LC/train240/test/Image/',
     "saliency_dir": r'/home/jxnu/LC/train240/test/gt/', "fixation_dir": r'/home/jxnu/LC/train240/test/fix/',
     "label": 1}
]
...
# scheduler = lr_scheduler.StepLR(optimizer, step_size=6, gamma=0.14)
scheduler = lr_scheduler.StepLR(optimizer, step_size=5, gamma=0.28)
...
for epoch in range(num_epochs):
    ...
    for batch in tqdm(train_loader, desc="Training"):
        ...
        loss1 = -2.6 * cc + 6.6 * kl - 3.3 * sim - 1.5 * nss
    ...
    if total_val_loss < best_loss:
        ...
        best_model_wts = copy.deepcopy(model.state_dict())
        torch.save(best_model_wts, 'ASD240.pth')
